...
import type { ResultMetaInterface } from './ResultMetaInterface.js';
export type { ResultMetaInterface } from './ResultMetaInterface.js';
...
export interface SearchProvider2Interface {
